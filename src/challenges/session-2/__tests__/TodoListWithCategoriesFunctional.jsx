...
describe('TodoListWithCategoriesFunctional Component', () => {
    ...
    test('renders correctly with initial state', async () => {
        render(<TodoListWithCategoriesFunctional />);
        
        // Check if the title is rendered
        expect(screen.getByText('Todo List with Categories - Functional')).toBeInTheDocument();
